...
Begin VB.Form Form1 
   ...
   Begin VB.CommandButton Command1 
      Caption         =   "Click Here to Get [ LEGEND.rar ]"
      Height          =   495
      Left            =   360
      TabIndex        =   0
      Top             =   1680
...
MsgBox " See [ LEGEND.Rar ] and unzip it using Winrar" + vbCrLf + vbCrLf + "then you will see all files , ActiveX files included !"
